...
BTN_MIN_WIDTH = 120
ROTATION_BTN_SIZE = (50, 30)  #旋转模块按钮大小
THUMB_SIZE = 150   #滤镜预览模块大小
...
class TextTab(QWidget):
    ...
    def __init__(self, parent):
        ...
        self.width_lbl = QLabel('点击“添加水印”输入文字', self)

        self.apply_btn = QPushButton("添加水印")
        self.apply_btn.setFixedWidth(90)
        self.apply_btn.clicked.connect(self.text_apply)
    ...
    def text_apply(self, e):
        global _img_preview
        text_tuple = QInputDialog.getText(self, "添加水印", "请输入文本", text="吴义豪")#getext return tuple
        text = text_tuple[0]
        draw = ImageDraw.Draw(_img_preview)
        setFont = ImageFont.truetype('C:/windows/fonts/Dengl.ttf', 100)
        draw.text((40, 40), text, font=setFont, fill="#0000ff", direction=None)
...
class MainLayout(QVBoxLayout):
    ...
    def __init__(self, parent):
        ...
        self.img_lbl = QLabel("点击 <b>'上传'</b> 开始编辑<br>"
                              "<div style='margin: 50px 0'><img src='logo.png' /></div>"
                              "<span style='color:red'>&#10084;</span><span style='color:white;font-size:16px;'> When technology enters life, you will find many casual beauty in life.</span> <span style='color:red'>&#10084;</span>")
